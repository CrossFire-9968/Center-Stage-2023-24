...
//            waitForMotionToComplete();
        ...
        public void dropLeftPixel() {
            ...
            int countsToRotateFromPixel = -455;       // 450 is about 45 degrees
            int driveDistanceToPark = -34;          // Inches
            ...
            mecanumAuto.rotate(autoDrivePower, countsToRotateFromPixel);
            waitForMotionToComplete();
            sleep(autoStateDelay);
        ...
        public void dropRightPixel() {
            ...
            int driveDistanceToStrafe = -34;     // Inches
            int strafeTowardBackdrop = 100;
