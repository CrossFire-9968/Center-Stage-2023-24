...
@Autonomous(name="Auto_nearRed")
public class Auto_nearRed extends LinearOpMode
{
   ...
   public void dropRightPixel() {
      ...
      int countsToRotateToPixel = 450;
      int strafeDistanceToTape = -45;         // Inches
      int driveDistanceToTape = -5;           // Inches
      int driveDistanceToDropPixel = 25;    // Inches
      int countsToRotateToPark = -5;     // 450 is about 45 degrees
   ...
   public void dropLeftPixel(){
      ...
      int countsToRotateToPark =
              80;       // 450 is about 45 degrees
      int strafeDistanceTopark = -30;         // Inches
      ...
      //Strafe
      mecanumAuto.strafe(drivePower, strafeDistanceTopark * countsToDriveOneInch);
      waitForMotionToComplete();
      sleep(500);
